<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Manage_jp.aspx.cs" Inherits="Manage_jp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td colspan="5" class="style38">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="SELECT batch AS BATCH_ID, subject AS SUBJECT_NAME, book AS BOOK_NAME, SUM(quantity) AS STOCK_IN FROM jp_entry GROUP BY batch, subject, book">
            </asp:SqlDataSource>
            <br />
        </td>
    </tr>
    ...
    <tr>
        <td colspan="5" 
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                SelectCommand="SELECT batch AS BATCH_ID, subject AS SUBJECT_NAME, book AS BOOK_NAME, SUM(counter) AS STOCK_ISSUED FROM jp_issue GROUP BY batch, subject, book">
            </asp:SqlDataSource>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="style32" colspan="2">
            <asp:TextBox ID="txtsname" runat="server" style="margin-left: 0px"></asp:TextBox>
        </td>
        <td class="style27">
    ...
    <tr>
        <td class="style31" colspan="2">
            EMAIL ID</td>
        <td class="style32" colspan="2">
            <asp:TextBox ID="txteid" runat="server" ontextchanged="TextBox3_TextChanged"></asp:TextBox>
        </td>
        <td class="style27">
    ...
    <tr>
        <td class="style31" colspan="2">
            MOBILE NO.</td>
        <td class="style32" colspan="2">
            <asp:TextBox ID="txtmno" runat="server" ontextchanged="TextBox4_TextChanged"></asp:TextBox>
        </td>
        <td class="style27">
    ...
    <tr>
        <td class="style43" colspan="5">
            ...
            <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                SelectCommand="SELECT [batch], [subject], [book] FROM [jp_book]">
            </asp:SqlDataSource>
        </td>
    </tr>
    <tr>
