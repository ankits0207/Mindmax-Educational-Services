<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Create_Stock_pp.aspx.cs" Inherits="Create_Stock_jp" %>
        ...
        <tr>
            ...
            <td class="style32">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT [batch] FROM [pp_batch]"></asp:SqlDataSource>
            </td>
            <td class="style42">
        ...
        <tr>
            ...
            <td class="style35" colspan="4">
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                    SelectCommand="SELECT [batch], [subject] FROM [pp_subject]">
                </asp:SqlDataSource>
            </td>
        </tr>
        <tr>
