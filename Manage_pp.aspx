<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Manage_pp.aspx.cs" Inherits="Manage_jp" %>
    ...
    <tr>
        <td colspan="5" class="style38">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="SELECT batch AS BATCH_ID, subject AS SUBJECT_NAME, book AS BOOK_NAME, SUM(quantity) AS STOCK_IN FROM pp_entry GROUP BY batch, subject, book">
            </asp:SqlDataSource>
            <br />
        </td>
    </tr>
    ...
    <tr>
        <td colspan="5" 
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                ...
                SelectCommand="SELECT batch AS BATCH_ID, subject AS SUBJECT_NAME, book AS BOOK_NAME, SUM(counter) AS STOCK_ISSUED FROM pp_issue GROUP BY batch, subject, book">
            </asp:SqlDataSource>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="style43" colspan="5">
            ...
            <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                SelectCommand="SELECT [batch], [subject], [book] FROM [pp_book]">
            </asp:SqlDataSource>
        </td>
    </tr>
    <tr>
