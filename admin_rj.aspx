<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="admin_rj.aspx.cs" Inherits="admin_jp" %>
        ...
        <tr>
            <td class="style20">
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                    DeleteCommand="DELETE FROM [rj_batch] WHERE [batch] = @batch" 
                    InsertCommand="INSERT INTO [rj_batch] ([batch]) VALUES (@batch)" 
                    SelectCommand="SELECT * FROM [rj_batch]">
                    <DeleteParameters>
        ...
        <tr>
            <td class="style20">
                ...
                <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                    DeleteCommand="DELETE FROM [rj_subject] WHERE [batch] = @batch AND [subject] = @subject" 
                    InsertCommand="INSERT INTO [rj_subject] ([batch], [subject]) VALUES (@batch, @subject)" 
                    SelectCommand="SELECT * FROM [rj_subject]">
                    <DeleteParameters>
                        <asp:Parameter Name="batch" Type="String" />
        ...
        <tr>
            <td class="style20">
                ...
                <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                    DeleteCommand="DELETE FROM [rj_book] WHERE [batch] = @batch AND [subject] = @subject AND [book] = @book" 
                    InsertCommand="INSERT INTO [rj_book] ([batch], [subject], [book]) VALUES (@batch, @subject, @book)" 
                    SelectCommand="SELECT * FROM [rj_book]">
                    <DeleteParameters>
                        <asp:Parameter Name="batch" Type="String" />
                        <asp:Parameter Name="subject" Type="String" />
        ...
        <tr>
            <td class="style20">
                ...
                <asp:SqlDataSource ID="SqlDataSource5" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                    DeleteCommand="DELETE FROM [rj_entry] WHERE [book] = @book AND [challan] = @challan" 
                    InsertCommand="INSERT INTO [rj_entry] ([batch], [subject], [book], [quantity], [challan], [date], [counsellor]) VALUES (@batch, @subject, @book, @quantity, @challan, @date, @counsellor)" 
                    SelectCommand="SELECT * FROM [rj_entry]" 
                    
                    UpdateCommand="UPDATE [rj_entry] SET [batch] = @batch, [subject] = @subject, [quantity] = @quantity, [date] = @date, [counsellor] = @counsellor WHERE [book] = @book AND [challan] = @challan">
                    <DeleteParameters>
                        <asp:Parameter Name="book" Type="String" />
        ...
        <tr>
            <td class="style20">
                ...
                <asp:SqlDataSource ID="SqlDataSource6" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                    DeleteCommand="DELETE FROM [rj_issue] WHERE [registration_no] = @registration_no AND [batch] = @batch AND [subject] = @subject AND [book] = @book" 
                    InsertCommand="INSERT INTO [rj_issue] ([st_name], [registration_no], [email_id], [mobile], [register_no], [page_no], [line_no], [datetime], [batch], [subject], [book], [counter]) VALUES (@st_name, @registration_no, @email_id, @mobile, @register_no, @page_no, @line_no, @datetime, @batch, @subject, @book, @counter)" 
                    SelectCommand="SELECT st_name, registration_no, email_id, mobile, batch, subject, book, counter, counsellor, date FROM rj_issue" 
                    
                    
                    UpdateCommand="UPDATE [rj_issue] SET [st_name] = @st_name, [email_id] = @email_id, [mobile] = @mobile, [register_no] = @register_no, [page_no] = @page_no, [line_no] = @line_no, [datetime] = @datetime, [counter] = @counter WHERE [registration_no] = @registration_no AND [batch] = @batch AND [subject] = @subject AND [book] = @book">
                    <DeleteParameters>
