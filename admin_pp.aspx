<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="admin_pp.aspx.cs" Inherits="admin_jp" %>
        ...
        <tr>
            <td class="style20">
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                    DeleteCommand="DELETE FROM [pp_batch] WHERE [batch] = @batch" 
                    InsertCommand="INSERT INTO [pp_batch] ([batch]) VALUES (@batch)" 
                    SelectCommand="SELECT [batch] FROM [pp_batch]">
                    <DeleteParameters>
        ...
        <tr>
            <td class="style20">
                ...
                <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                    DeleteCommand="DELETE FROM [pp_subject] WHERE [batch] = @batch AND [subject] = @subject" 
                    InsertCommand="INSERT INTO [pp_subject] ([batch], [subject]) VALUES (@batch, @subject)" 
                    SelectCommand="SELECT * FROM [pp_subject]">
                    <DeleteParameters>
                        <asp:Parameter Name="batch" Type="String" />
        ...
        <tr>
            <td class="style20">
                ...
                <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                    DeleteCommand="DELETE FROM [pp_book] WHERE [batch] = @batch AND [subject] = @subject AND [book] = @book" 
                    InsertCommand="INSERT INTO [pp_book] ([batch], [subject], [book]) VALUES (@batch, @subject, @book)" 
                    SelectCommand="SELECT * FROM [pp_book]">
                    <DeleteParameters>
                        <asp:Parameter Name="batch" Type="String" />
                        <asp:Parameter Name="subject" Type="String" />
        ...
        <tr>
            <td class="style20">
                ...
                <asp:SqlDataSource ID="SqlDataSource5" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                    DeleteCommand="DELETE FROM [pp_entry] WHERE [book] = @book AND [challan] = @challan" 
                    InsertCommand="INSERT INTO [pp_entry] ([batch], [subject], [book], [quantity], [challan], [date], [counsellor]) VALUES (@batch, @subject, @book, @quantity, @challan, @date, @counsellor)" 
                    SelectCommand="SELECT * FROM [pp_entry]" 
                    
                    UpdateCommand="UPDATE [pp_entry] SET [batch] = @batch, [subject] = @subject, [quantity] = @quantity, [date] = @date, [counsellor] = @counsellor WHERE [book] = @book AND [challan] = @challan">
                    <DeleteParameters>
                        <asp:Parameter Name="book" Type="String" />
        ...
        <tr>
            <td class="style20">
                ...
                <asp:SqlDataSource ID="SqlDataSource6" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                    DeleteCommand="DELETE FROM [pp_issue] WHERE [registration_no] = @registration_no AND [batch] = @batch AND [subject] = @subject AND [book] = @book" 
                    InsertCommand="INSERT INTO [pp_issue] ([st_name], [registration_no], [email_id], [mobile], [register_no], [page_no], [line_no], [datetime], [batch], [subject], [book], [counter]) VALUES (@st_name, @registration_no, @email_id, @mobile, @register_no, @page_no, @line_no, @datetime, @batch, @subject, @book, @counter)" 
                    SelectCommand="SELECT st_name, registration_no, email_id, mobile, batch, subject, book, counter, counsellor, date FROM pp_issue" 
                    
                    
                    UpdateCommand="UPDATE [pp_issue] SET [st_name] = @st_name, [email_id] = @email_id, [mobile] = @mobile, [register_no] = @register_no, [page_no] = @page_no, [line_no] = @line_no, [datetime] = @datetime, [counter] = @counter WHERE [registration_no] = @registration_no AND [batch] = @batch AND [subject] = @subject AND [book] = @book">
                    <DeleteParameters>
