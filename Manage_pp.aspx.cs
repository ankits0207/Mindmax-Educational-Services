...
public partial class Manage_jp : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand("select * from pp_issue", con);
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            for (int i = 0; i <= GridView4.Rows.Count - 1; i++)
            {
                ...
                if (Chbox.Checked == true)
                {
                    SqlCommand cmd = new SqlCommand("insert into pp_issue values('" + sname + "','" + regno + "','" + eid + "','" + mno + "','" + batch + "','" + subject + "','" + book + "','" + ddldefault.Text + "','" + Session["name"].ToString() + "','" + txtissuedate.Text + "')", con);
                    con.Open();
                    cmd.ExecuteNonQuery();
                    con.Close();
                }
            ...
            Response.Redirect("Manage_pp.aspx");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            SqlCommand cmd = new SqlCommand("insert into pp_students values('" + txtsname.Text + "','" + txtregno.Text + "','" + txteid.Text + "','" + txtmno.Text + "')", con);
            con.Open();
            cmd.ExecuteNonQuery();
            Label1.Visible = true;
    ...
    protected void Button5_Click(object sender, EventArgs e)
    {
        try
        {
            cmdn = new SqlCommand("select * from pp_students", con);
